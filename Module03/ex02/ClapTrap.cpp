...
/*   Updated: 2025/06/06 15:34:58 by rafaria          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string& target)
{
    ...
    if (this->_HitPts <= 0)
    {
        std::cout << "ClapTrap or FragTrap " << this->getName()
...
void ClapTrap::takeDamage(unsigned int amount)
{
    if (this->_HitPts <= 0)
    {
        std::cout << "ClapTrap or FragTrap " << this->getName() << " is already dead and can't take more damage." << std::endl;
        return;
    }
...
void ClapTrap::beRepaired(unsigned int amount)
{
    if (this->_HitPts <= 0)
    {
        std::cout << "ClapTrap or FragTrap " << this->getName() << " is dead and can't be repaired." << std::endl;
        return;
    }
    
    if (this->_EnergyPts <= 0)
    {
        std::cout << "ClapTrap or FragTrap " << this->getName() << " has no energy left to repair itself." << std::endl;
        return;
    }
